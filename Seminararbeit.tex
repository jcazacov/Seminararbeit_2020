...
\begin{equation}
	T_n(x)=\frac{f(x_0)}{0!}\times(x-x_0)^0 + \frac{f(x_0)}{1!}\times(x-x_0)^1 + \frac{f(x_0)}{2!}\times(x-x_0)^2 + \dots +\frac{f(x_0)}{n!}\times(x-x_0)^n
\end{equation} %Video von Mathepeter
,wobei bei steigender Anzahl $n$ der Polynomglieder die Genauigkeit der Annäherung steigt. Als $x_0$ wird ein Wert ausgesucht bei dem die Berechnungen einfacher durchzuführen sind. 
