...
\footnote{Vgl. Schmidt, Harald, Elementare Technomathematik, Amberg 2018}
	...
	\begin{tikzpicture}[line cap=round,line join=round,>=triangle 45,x=1cm,y=1cm]
		\begin{axis}[
			...
			\begin{scriptsize}
				...
				\draw[color=black] (1.3,1.15) node {\large $l$};
				\draw[color=black] (1.5,2.3) node {\large $l\times sin(\varphi)$};
				\draw[color=black] (3.8,0.95) node {\large $l \times cos(\varphi)$};
			\end{scriptsize}
		\end{axis}
	\end{tikzpicture}
...
\footnote{Engel, Joachim; Fest, Andreas: Komplexe Zahlen und ebene Geometrie, Ludwigsburg $2009^3$, S. $32$}
...
\begin{small}
	Abbildung $2$: fünfte Wurzeln aus $1$
\end{small}
...
Erinnern wir uns, dass die Eckpunkte des Vielecks auf dem Einheitskreis auch als Lösungen der Gleichung $z^n=1$ beziehungsweise $z^n-1=0$ dargestellt werden konnten. Die erweiterte Fassung des Fundamentalsatzes der Algebra (\ref{eq:funda2}) besagt nun, dass %nicht ganz Fundamentalsatz, sondern Faktorzerlegung
